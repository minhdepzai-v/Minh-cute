...
Dungeon = game.PlaceId == 73902483975735
Sea = World1 or World2 or World3 or Dungeon or plr:Kick("❌ Only Blox Fruits ❌")
...
local Sea = Window:MakeTab({
    "Tab Sea Events", "anchor"
})
local ITM = Window:MakeTab({
    "Tab Multi Farm", "swords"
})
local Drago = Window:MakeTab({
    "Tab Dragon Dojo", "scroll"
})
local Travel = Window:MakeTab({
    "Tab Traveling", "locate"
})
...
local Race = Window:MakeTab({
    "Tab Upgrade Race", "user-cog"
})
local Plr = Window:MakeTab({
    "Tab Local Player", "user"
})
local Shop = Window:MakeTab({
    "Tab Shop", "shopping-cart"
})
local Misc = Window:MakeTab({
    "Tab Misc", "circle-ellipsis"
})
Window:SelectTab(Main)

AddSection({"Select Weapon"})
local _Weapon = {
    "Melee",
    "Sword",
    "Blox Fruit",
